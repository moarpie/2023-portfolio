...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
    <div class="order-2 md:order-1">
        ...
        <p>
            During my work on this project I have conducted a great deal of user interviews with the different types of users, to uncover user pains regarding the old design and how we could address these and other possible user needs for the new and improved layout.
        </p>
    </div>
    <div class="order-1 md:order-2">
        <img src="$lib/assets/img/cases/inwido/inwido1.png" alt="" />
    </div>
</div>
